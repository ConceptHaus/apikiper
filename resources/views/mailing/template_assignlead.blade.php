...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    ...
    <body>
        <span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;">Recibiste un nuevo prospecto</span>
...
<div style="text-align: center; color:#54595D"><span><font face="Poppins, helvetica, arial, verdana, sans-serif"><span style="font-size:28px">¡Hola {{$nombre}}!</span><br>
<span style="color:#A3A9AC; font-size:14px">Te han asignado un nuevo lead, no lo pierdas de vista.</span></font></span></div>
            ...
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-style: normal; font-weight: normal;">
                            ...
                            <div dir="ltr" style="color: #A3A9AC; text-align: center;"><span style="font-size:16px"><font face="Poppins, helvetica, arial, verdana, sans-serif">Nombre</font></span></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <div style="text-align: left;"><a href="https://www.w3schools.com/html/"><font color="#e43d30" face="Poppins, helvetica, arial, verdana, sans-serif"><span style="font-size:16px"><strong>{{ $nombre_p }} {{ $apellido_p }}</strong></span></font></a></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-style: normal; font-weight: normal;">
                            ...
                            <div style="text-align: left;"><a href="https://www.w3schools.com/html/"><font color="#e43d30" face="Poppins, helvetica, arial, verdana, sans-serif"><span style="font-size:16px"><strong>{{ $correo_p }}</strong></span></font></a></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-style: normal; font-weight: normal;">
                            ...
                            <div dir="ltr" style="color: #A3A9AC; text-align: center;"><span style="font-size:16px"><font face="Poppins, helvetica, arial, verdana, sans-serif">Empresa</font></span></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-style: normal; font-weight: normal;">
                            ...
                            <div style="text-align: left;"><a href="https://www.w3schools.com/html/"><font color="#e43d30" face="Poppins, helvetica, arial, verdana, sans-serif"><span style="font-size:16px"><strong>{{ $empresa_p }}</strong></span></font></a></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-style: normal; font-weight: normal;">
                            ...
                            <div dir="ltr" style="color: #A3A9AC; text-align: center;"><span style="font-size:16px"><font face="Poppins, helvetica, arial, verdana, sans-serif">Telefono</font></span></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-style: normal; font-weight: normal;">
                            ...
                            <div style="text-align: left;"><a href="https://www.w3schools.com/html/"><font color="#e43d30" face="Poppins, helvetica, arial, verdana, sans-serif"><span style="font-size:16px"><strong>{{ $telefono_p }}</strong></span></font></a></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-style: normal; font-weight: normal;">
                            ...
                            <div dir="ltr" style="color: #A3A9AC; text-align: center;"><span style="font-size:16px"><font face="Poppins, helvetica, arial, verdana, sans-serif">Mensaje</font></span></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-style: normal; font-weight: normal;">
                            ...
                            <div style="text-align: left;"><a href="https://www.w3schools.com/html/"><font color="#e43d30" face="Poppins, helvetica, arial, verdana, sans-serif"><span style="font-size:16px"><strong>{{ $mensaje_p }}</strong></span></font></a></div>
