...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	...
	/*
	 Mobile Styles
	 Heading 2
	 the second-level headings larger in size for better readability on small screens.
	*/
		h2{
	...
	/*
	 Mobile Styles
	 Heading 3
	 the third-level headings larger in size for better readability on small screens.
	*/
		h3{
	...
	/*
	 Mobile Styles
	 Heading 4
	 the fourth-level headings larger in size for better readability on small screens.
	*/
		h4{
	...
	/*
	 Mobile Styles
	 Boxed Text
	 the boxed text larger in size for better readability on small screens. We recommend a font size of at least 16px.
	*/
	...
	*/
	...
	/*
	 Mobile Styles
	 Header Text
	 the header text larger in size for better readability on small screens.
	*/
		#templateHeader .mcnTextContent,#templateHeader .mcnTextContent p{
			font-size:16px !important;
			line-height:150% !important;
	...
	/*
	 Mobile Styles
	 Body Text
	 the body text larger in size for better readability on small screens. We recommend a font size of at least 16px.
	*/
		#templateBody .mcnTextContent,#templateBody .mcnTextContent p{
			font-size:16px !important;
			line-height:150% !important;
	...
	/*
	 Mobile Styles
	 Footer Text
	 the footer content text larger in size for better readability on small screens.
	*/
		#templateFooter .mcnTextContent,#templateFooter .mcnTextContent p{
			font-size:14px !important;
			line-height:150% !important;
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/766ee0c962d543c02140cdccb/images/ce206b8f-0292-4cff-9853-81fbb8ba680e.gif" width="600" style="max-width: 600px; padding-bottom: 0px; vertical-align: bottom; display: inline !important; border-radius: 0%;" class="mcnImage">
...
<div style="text-align: center;"><font face="Poppins, helvetica, arial, verdana, sans-serif"><span style="color: #54595D;font-size: 28px;">¡Hola {{$user->nombre}}!</span><br>
<font color="#a3a9ac"><span style="font-size:14px">Estos son los status de tus oportunidades del {{$inicio}} al {{$fin}}</span></font></font></div>
					...
					<table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%"
						...
						<tbody>
							<tr>
								...
								<td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #E74740;">
					
									<div style="text-align: center;">
										<font face="Poppins, helvetica, arial, verdana, sans-serif">
											<font color="#a3a9ac"><span style="font-size:14px">Oportunidades {{$r->status}}</span></font>
										</font><br>
										<br>
										<span style="font-size:32px">
											<font face="Poppins, helvetica, arial, verdana, sans-serif">
												<font color="{{$r->color}}">{{$r->total}}</font>
											</font>
										</span>
									</div>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif; font-size: 16px; padding: 16px;">
                                <a class="mcnButton " title="Ingresar" href="https://crmv2.kiper.app" target="_blank" style="font-weight: bold;letter-spacing: 0px;line-height: 100%;text-align: center;text-decoration: none;color: #E74740;">Ver estadísticas</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
