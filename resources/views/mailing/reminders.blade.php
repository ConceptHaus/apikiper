...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
	<head>
		...
		<title>KIPER | RECORDATORIOS </title>
    ...
    <body>
        <span class="mcnPreviewText" style="display:none; font-size:0px; line-height:0px; max-height:0px; max-width:0px; opacity:0; overflow:hidden; visibility:hidden; mso-hide:all;"> NUEVO RECORDATORIO </span>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                        ...
                                        <img align="center" alt="" src="https://gallery.mailchimp.com/766ee0c962d543c02140cdccb/images/9cdb741f-d9d2-4839-a585-6a14ca3ec15d.gif" width="600" style="max-width: 600px; padding-bottom: 0px; vertical-align: bottom; display: inline !important; border-radius: 0%;" class="mcnImage">
...
<div style="text-align: center; color:#54595D"><span><font face="Poppins, helvetica, arial, verdana, sans-serif"><span style="font-size:28px">Recordatorio</span></font></span></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                            ...
                            <div style="text-align: justify; margin: 10px 40px;"><span style="font-size:18px"><span style="color:#54595D"><font face="Poppins, helvetica, arial, verdana, sans-serif">{{$nombre}} debes {{$nota_recordatorio}} con {{$nombre_prospecto}} {{$apellido_prospecto}} a las {{$date}}</font></span></span></div>
