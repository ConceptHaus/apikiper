...
<span style="color:#A3A9AC; font-size:14px">Tienes un nuevo lead de llamada, no lo pierdas de vista.</span></font></span></div>
            ...
            <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <div style="text-align: left;"><a href="https://www.w3schools.com/html/"><font color="#e43d30" face="Poppins, helvetica, arial, verdana, sans-serif"><span style="font-size:16px"><strong>{{ $nombre_p }}</strong></span></font></a></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-style: normal; font-weight: normal;">
                            ...
                            <div dir="ltr" style="color: #A3A9AC; text-align: center;"><span style="font-size:16px"><font face="Poppins, helvetica, arial, verdana, sans-serif">Keyword</font></span></div>
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:300px;" width="100%" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px; font-style: normal; font-weight: normal;">
                            ...
                            <div style="text-align: left;"><a href="https://www.w3schools.com/html/"><font color="#e43d30" face="Poppins, helvetica, arial, verdana, sans-serif"><span style="font-size:16px"><strong>{{ $term_p }}</strong></span></font></a></div>
                    ...
                    <tbody>
                        <tr>
                            <td align="center" valign="middle" class="mcnButtonContent" style="font-family: &quot;Helvetica Neue&quot;, Helvetica, Arial, Verdana, sans-serif; font-size: 16px; padding: 16px;">
                                <a class="mcnButton " title="Ingresar" href="{{$recording_p}}?token=67912-aebf84e24aabbb94" target="_blank" style="font-weight: bold;letter-spacing: 0px;line-height: 100%;text-align: center;text-decoration: none;color: #E74740;">Escucha la grabación</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
