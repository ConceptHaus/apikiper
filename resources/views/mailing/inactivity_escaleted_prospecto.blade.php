        ...
        <td>
          <table>
            <tbody style="vertical-align:top">
              ...
              <tr>
                <td>
                  <span style="font-size:16px;font-weight:bold;color:#000000">Hola, {{$msg['admin']}}!</span>
                </td>
              </tr>
              <tr>
                <td height="20"></td>
              ...
              <tr>
                <td>
                  <p style="font-size:14px;color:#000">Esta es la notificacion número: {{$msg['attempt']}} para <b style="font-weight:bold;">{{$msg['colaborador']}}.</b>
                    El prospecto {{$msg['nombre_oportunidad']}} ha estado <b style="font-weight:bold;">inactivo por mas de {{$msg['inactivity_period']}} horas</b>.
                  </p>
                </td>
              </tr>
              <tr>
