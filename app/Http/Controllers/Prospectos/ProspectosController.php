   ...
   public function registerProspecto(Request $request){
    ...
    public function updateProspecto(Request $request, $id){
        ...
        try{
            ...
            $prospecto->correo = $request->correo;
            $detalle->idIntSoc = $request->idIntSoc;
            ...
            $detalle->callef = $request->callef;
            $detalle->numf = $request->numf;
            $detalle->munf = $request->munf;
            $detalle->cpf = $request->cpf;
            $detalle->correoof = $request->correof;
            $detalle->nombrec = $request->nombrec;
            $detalle->correocont = $request->correocont;
            $detalle->correobol = $request->correobol;
            $detalle->reprelegal = $request->reprelegal;
            $detalle->contacprin = $request->contacprin;
