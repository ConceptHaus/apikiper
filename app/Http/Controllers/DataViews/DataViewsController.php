...
class DataViewsController extends Controller
{
    ...
    public function prospectosstatus($status){
        $prospectos = DB::table('prospectos')
                        ...
                        ->select('prospectos.id_prospecto','prospectos.nombre','prospectos.apellido','detalle_prospecto.telefono','prospectos.created_at','cat_fuentes.nombre as fuente','cat_fuentes.url as fuente_url','cat_status_prospecto.status','cat_status_prospectoid_cat_status_prospecto as id_status')
