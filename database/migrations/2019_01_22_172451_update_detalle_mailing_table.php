...
class UpdateDetalleMailingTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('detalle_mailings', function (Blueprint $table) {
            ...
            $table->string('fondo_general')->nullable()->default(null)->change();
            $table->string('fondo_cta')->nullable()->default(null)->change();
            $table->string('color_titulo')->nullable()->default(null)->change();
            $table->string('color_subtitulo')->nullable()->default(null)->change();
            $table->string('color_lineas')->nullable()->default(null)->change();
