...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $archivos_prospecto=factory(App\Modelos\Prospecto\ArchivosProspectoColaborador::class,200)->create();
        $archivos_oportunidad=factory(App\Modelos\Oportunidad\ArchivosOportunidadColaborador::class,200)->create();
        ...
        $etiquetas_oportunidad = factory(App\Modelos\Oportunidad\EtiquetasOportunidad::class,250)->create();
        $servicios_oportunidad = factory(App\Modelos\Oportunidad\ServicioOportunidad::class,250)->create();
        $evento_prospecto = factory(App\Modelos\Extras\EventoProspecto::class,100)->create()
                            ->each(function($e){
                                $e->detalle()->save(factory(App\Modelos\Extras\DetalleEventoProspecto::class)->make());
                            });

        $evento_oportunidad=factory(App\Modelos\Extras\EventoOportunidad::class,100)->create()
                            ->each(function($e){
                                $e->detalle()->save(factory(App\Modelos\Extras\DetalleEventoOportunidad::class)->make());
                            });

        $recordatorio_prospecto=factory(App\Modelos\Extras\RecordatorioProspecto::class,100)->create()
                            ->each(function($e){
                                $e->detalle()->save(factory(App\Modelos\Extras\DetalleRecordatorioProspecto::class)->make());
                            });

        $recordatorio_oportunidad=factory(App\Modelos\Extras\RecordatorioOportunidad::class,100)->create()
                            ->each(function($e){
