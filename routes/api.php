...
Route::prefix('/v1')->group(function(){
    Route::middleware(['api','cors'])->group(function(){
        ...
        Route::get('/download/prospectos/{role_id}/{rol}/{id_user}/{correos}/{nombre}/{telefono}/{status}/{grupo}/{etiquetas}/{fechaInicio}/{fechaFin}/{colaboradores}/{busqueda}/{rama}/{estatussocio}','Prospectos\ProspectosController@downloadProspectos');
    });
});
...
Route::prefix('/v1/oportunidades')->group(function(){
        Route::middleware(['auth','cors'])->group(function(){
            ...
            Route::get('/{id}/objeciones','Oportunidades\OportunidadesController@getObjecion');
            Route::post('/{id}/objeciones','Oportunidades\OportunidadesController@addObjeciones');
            Route::delete('/objeciones/{objecion}', 'Oportunidades\OportunidadesController@deleteObjeciones');
